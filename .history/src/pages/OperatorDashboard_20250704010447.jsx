...
// Removed OperatorSidebar import
...
const OperatorDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Sidebar removed: now handled by OperatorLayout */}
      {sidebarOpen && (
        <div 
      ...
      <main className="p-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400">ID: {operatorData?.id || '--'}{/* Machine ID will be shown only when operator is assigned to a machine */}{operatorData?.machineId ? ` • Machine: ${operatorData.machineId}` : ''}</p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {todayTasks.length === 0 ? (
              <div className="text-gray-400 col-span-2">No tasks assigned for today.</div>
            ) : (
              todayTasks.map((task) => (
        ...
        <div className="mt-8 bg-white rounded-xl p-6 shadow-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <button
              className="bg-black hover:bg-gray-800 text-white p-4 rounded-lg font-medium transition-all duration-200 flex flex-col items-center space-y-2"
