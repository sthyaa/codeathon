...
const Training = () => {
  ...
  // Handler for YouTube player progress
  const handlePlayerProgress = (event, courseId) => {
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="aspect-w-16 aspect-h-9 w-full mb-4">
                      <YouTube
                        ...
                        onPlayback={null}
                        onPlay={(e) => handlePlayerProgress(e, selectedCourse.id)}
                        onPause={(e) => handlePlayerProgress(e, selectedCourse.id)}
                        onEnd={(e) => handlePlayerStateChange(e, selectedCourse.id)}
                        onProgress={(e) => handlePlayerProgress(e, selectedCourse.id)}
                        onTimeUpdate={(e) => handlePlayerProgress(e, selectedCourse.id)}
                      />
                      {/* Progress bar */}
