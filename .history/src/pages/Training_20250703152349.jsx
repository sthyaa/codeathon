  ...
  const courses = [
    {
      ...
      enrolled: 1250,
      completed: true,
      description: 'Learn the basics of CAT excavator operation with hands-on demonstrations',
      videoUrl: 'https://www.youtube.com/embed/1Q8fG0TtVAY', // Example YouTube embed
      instructor: 'Mike Johnson',
      topics: ['Basic Controls', 'Startup Procedures', 'Safety Checks']
    },
    {
      id: 2,
      ...
      enrolled: 890,
      completed: false,
      description: 'Interactive simulation of hydraulic system operations and troubleshooting',
      videoUrl: 'https://www.youtube.com/embed/2Xc9gXyf2G4',
      instructor: 'Sarah Chen',
      topics: ['Hydraulic Principles', 'System Diagnostics', 'Maintenance']
    },
    {
      id: 3,
      ...
      enrolled: 2100,
      completed: true,
      description: 'Live interactive workshop on construction site safety protocols',
      thumbnail: '/api/placeholder/300/200',
      instructor: 'David Miller',
      topics: ['Site Safety', 'Equipment Inspection', 'Emergency Procedures']
    },
    {
      id: 4,
      ...
      enrolled: 1680,
      completed: false,
      description: 'Learn advanced techniques to optimize fuel consumption',
      thumbnail: '/api/placeholder/300/200',
      instructor: 'Lisa Rodriguez',
      topics: ['Efficient Operation', 'Load Management', 'Idle Reduction']
    },
    {
      id: 5,
      title: 'Maintenance Checklist Mastery',
      type: 'interactive',
      duration: '1.5 hours',
      difficulty: 'Intermediate',
      rating: 4.8,
      enrolled: 1450,
      completed: true,
      description: 'Interactive checklist training with real-world scenarios',
      thumbnail: '/api/placeholder/300/200',
      instructor: 'Tom Wilson',
      topics: ['Daily Inspections', 'Preventive Maintenance', 'Record Keeping']
    },
    {
      id: 6,
      ...
      enrolled: 750,
      completed: false,
      description: 'Simulated emergency scenarios and proper response procedures',
      thumbnail: '/api/placeholder/300/200',
      instructor: 'Emma Thompson',
      topics: ['Emergency Protocols', 'First Aid', 'Equipment Shutdown']
    }
  ];
