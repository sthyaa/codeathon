            ...
            {selectedCourse && selectedCourse.videoUrl && (
              <div className="bg-white rounded-xl shadow-lg p-6 mb-6 border border-gray-200">
                <div className="flex flex-col md:flex-row md:items-center md:space-x-6">
                  <div className="w-full md:w-2/3 aspect-w-16 aspect-h-9 mb-4 md:mb-0">
                    <iframe
                      width="100%"
                      height="400"
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-black mb-2">{selectedCourse.title}</h3>
                    <p className="text-gray-700 mb-2">{selectedCourse.description}</p>
                    <div className="flex items-center space-x-4 mb-2">
                      <span className="text-sm text-gray-600 flex items-center"><Clock className="w-4 h-4 mr-1" />{selectedCourse.duration}</span>
                      <span className="text-sm text-gray-600 flex items-center"><Users className="w-4 h-4 mr-1" />{selectedCourse.enrolled}</span>
                    ...
                    <button onClick={() => setSelectedCourse(null)} className="mt-4 text-sm text-gray-500 hover:text-black underline">Close Video</button>
                  </div>
                </div>
              </div>
            )}
